...
buttonElement.addEventListener('click', 
    function() { 
        ...
        if (numero < 1 || numero > 100){
            ...
            resultadoMensagemElement.innerHTML = '<br>'+'<strong> VOCÊ ERROU... TENTE NOVAMENTE... </strong>'+'<br><br>'+'o número sorteado é maior que o número digitado ' + numero;
            ...
            resultadoMensagemElement.classList.remove('result-error');
            resultadoMensagemElement.classList.add('result-fail');
            resultadoMensagemElement.innerHTML = '<br>'+'<strong> VOCÊ ERROU... TENTE NOVAMENTE... </strong>'+'<br><br>'+'o número sorteado  é menor que o número digitado ' + numero;
            ...
            resultadoMensagemElement.innerHTML = '<br>'+'<strong> PARABÉNS ! VOCÊ ACERTOU !!! </strong>' + '<br><br>' +'o número sorteado  ' + sorteado + '  é igual ao número digitado ' + numero + '<br><br>'+'acertou na tentativa número: '+ tentativas;
